...
func registerTools(server *mcp.Server, api *apiClient) {
	...
	}, func(ctx context.Context, _ *mcp.CallToolRequest, args searchLawsArgs) (*mcp.CallToolResult, any, error) {
	...
	}, func(ctx context.Context, _ *mcp.CallToolRequest, args getLawRevisionsArgs) (*mcp.CallToolResult, any, error) {
	...
	}, func(ctx context.Context, _ *mcp.CallToolRequest, args getLawDataArgs) (*mcp.CallToolResult, any, error) {
	...
	}, func(ctx context.Context, _ *mcp.CallToolRequest, args keywordSearchArgs) (*mcp.CallToolResult, any, error) {
